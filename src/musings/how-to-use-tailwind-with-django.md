...
description: Have you been hearing about how cool Tailwind is but are not sure how to use it with Django? Then this blog post is for you!
twitterCard: summary_large_image
permalink: /musings/2020/12/how-to-use-tailwind-with-django/
---
...
```django
<link rel="stylesheet" href="{% raw %}{% static 'tailwind/styles.css' %}{% endraw %}">
```
