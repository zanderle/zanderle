...
description: Modern JavaScript is in many ways very similar to Python. But it's also very different. I notice a lot of Python developers don't really leverage those similarities and aren't too familiar with the differences. Which is a shame.
twitterCard: summary_large_image
permalink: /musings/2021/1/5-javascript-things-you-should-knowithunderstand-as-a-python-developer/
---
...
Well, similar thing happens to JavaScript ALL THE TIME. One of the common problems is that people don't embrace the functional programming capabilities of the language, because they're too used to solving problems through OOP. [Here's a good talk](https://www.youtube.com/watch?v=e-5obm1G_FY) if you're not familiar with functional programming.
...
That was a very brief overview. If this is something you'd be interested in learning more about (with actual explanations and examples, not just skimming over), check out the course I'm building: [Modern JavaScript for Python Developers](https://javascriptforpython.dev). It's designed to leverage your Python skills to really get a handle on JavaScript. You'll learn all the places where your Python knowledge translates easily, and all the places where JavaScript is very different. That way your learning will be very efficient, because you won't waste time on concepts/syntax you're already familiar with. Instead, you'll be able to focus on stuff that's tricky and unexpected.

[Visit the website](https://javascriptforpython.dev) and sign up to the mailing list to be notified when the course will be released.
