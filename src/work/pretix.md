...
excerpt: '"When we started planning to extend our event ticketing software with a seating plan feature, we knew that we could not do this on our own – the amount of work involved would have made it impossible to build this in-house in the time frame we imagined. We''ve been lucky to find a professional as skilled as Žan to implement the frontend component of this project." — Raphael Michel, Founder'
showDetails: false
image: /assets/work/pretix/logo_dark.512px.png
---
